...
public class ExperimentManager : MonoBehaviour
{
    ...
    [SerializeField] private Toggle toggle_ScrewGaugePresent;
    ...
    private void Start()
    {
        ...
        toggle_ScrewGaugePresent.onValueChanged.AddListener(_ => UpdateChecklist());
